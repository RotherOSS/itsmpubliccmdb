...
Basic Configuration
-------------------
Open the Package Manager module from the Administration group in the Agent Interface. Select the package named ITSMPublicCMDB from the Online Repository. Click the associated  *Install* link on that line and respond affirmatively to any confirmation questions that may follow.

For each class to be viewed, add the *Public* item to its Interfaces list (through *Admin->Config Items->Change Class Definition*). Furthermore enable one of the system configurations of the *Public::ConfigItem::PermissionConditions* group and add the class name to the *Classes* list field.
